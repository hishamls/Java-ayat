 ...
 * @author hishamls
 */
public class frm_ayat_en_Semester extends javax.swing.JFrame {
    
    public static int sEdit;

    
    public frm_ayat_en_Semester() {
        initComponents();
        dp.Go.semester();
    }
    ...
    private void initComponents() {
        ...
        rdo_Group = new javax.swing.ButtonGroup();
        btn_back = new javax.swing.JButton();
        rdo_FirstSims = new javax.swing.JRadioButton();
        rdo_SecondSims = new javax.swing.JRadioButton();
        btn_sem_edit = new javax.swing.JButton();
        ...
        getContentPane().add(btn_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 441, 135, 45));

        rdo_FirstSims.setBackground(new java.awt.Color(0, 0, 0, 80));
        rdo_Group.add(rdo_FirstSims);
        rdo_FirstSims.setFont(new java.awt.Font("Chilanka", 0, 12)); // NOI18N
        rdo_FirstSims.setForeground(new java.awt.Color(153, 255, 153));
        rdo_FirstSims.setSelected(true);
        rdo_FirstSims.setText("First Semester");
        getContentPane().add(rdo_FirstSims, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 243, -1, -1));

        rdo_SecondSims.setBackground(new java.awt.Color(0, 0, 0, 80));
        rdo_Group.add(rdo_SecondSims);
        rdo_SecondSims.setFont(new java.awt.Font("Chilanka", 0, 12)); // NOI18N
        rdo_SecondSims.setForeground(new java.awt.Color(153, 255, 153));
        rdo_SecondSims.setText("Second Semester");
        getContentPane().add(rdo_SecondSims, new org.netbeans.lib.awtextra.AbsoluteConstraints(477, 243, -1, -1));

        btn_sem_edit.setFont(new java.awt.Font("Chilanka", 0, 14)); // NOI18N
        btn_sem_edit.setText("Edit");
        btn_sem_edit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_sem_editActionPerformed(evt);
            }
        });
        getContentPane().add(btn_sem_edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(378, 297, 135, 45));
    ...
    private void mnI_infoUsr_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnI_infoUsr_ActionPerformed
            Tools.openForm(new frm_ayat_en_Student_Info());
    ...
    private void btn_sem_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_sem_editActionPerformed
        dp.Go.modifi_Sem();
    }//GEN-LAST:event_btn_sem_editActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_ayat_en_Semester.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_ayat_en_Semester().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btn_sem_edit;
    ...
    public static javax.swing.JRadioButton rdo_FirstSims;
    private javax.swing.ButtonGroup rdo_Group;
    public static javax.swing.JRadioButton rdo_SecondSims;
