 ...
 * @author hishamls
 */
public class frm_ayat_en_Student_Info extends javax.swing.JFrame {

    static entity.Ayat_Student st;
    public static int sEdit;

    public frm_ayat_en_Student_Info()  {
        initComponents();
        int ids = dp.Go.idD;
//        int ids =entity.Ayat_Student.ID; // not forget we made ID public
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 270, 240, 9));
        ...
        getContentPane().add(txt_sMobile, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 225, 240, 40));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(216, 288, -1, -1));
        ...
        getContentPane().add(txt_EMail, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 279, 240, 40));
        getContentPane().add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 320, 240, 9));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(216, 342, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_ayat_en_Student_Info.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                    ...
                    new frm_ayat_en_Student_Info().setVisible(true);
